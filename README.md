...
For dl-poly please provide at least the files from this table if applicable to your
...
```
git clone https://gitlab.mpcdf.mpg.de/nomad-lab/parser-dl-poly parser-dl-poly
pip install -e parser-dl-poly
```
